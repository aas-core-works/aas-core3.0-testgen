...
class ClassGraph:
    ...
    shortest_paths_from_environment: Final[ShortestPathMap]
    ...
    def __init__(
        ...
        self.shortest_paths_from_environment = shortest_paths_from_environment
...
def compute_class_graph(symbol_table: intermediate.SymbolTable) -> ClassGraph:
    ...
    return ClassGraph(
        ...
        shortest_paths_from_environment=_compute_shortest_paths_from_environment(
