...
class Instance:
    ...
    def __init__(
        self, properties: OrderedDict[str, ValueUnion], class_name: Identifier
    ) -> None:
        """
...
class _Preserializer(
    aas_types.AbstractTransformer[Instance]
):
    """Transform instances to a pre-serialized representation."""
    def __init__(self) -> None:
        """Initialize empty."""
        self.instance_to_preserialized = dict(
    ...
    def transform_extension(
        ...
        if that.semantic_id is not None:
            properties['semantic_ID'] = (
                self.transform(that.semantic_id)
            )

        if that.supplemental_semantic_ids is not None:
            properties['supplemental_semantic_IDs'] = (
                ListOfInstances(
                    [
                        self.transform(item)
    ...
    def transform_administrative_information(
        ...
        if that.embedded_data_specifications is not None:
            properties['embedded_data_specifications'] = (
                ListOfInstances(
                    [
                        self.transform(item)
    ...
    def transform_asset_administration_shell(
        ...
        if that.administration is not None:
            properties['administration'] = (
                self.transform(that.administration)
            )
        ...
        if that.derived_from is not None:
            properties['derived_from'] = (
                self.transform(that.derived_from)
            )

        properties['asset_information'] = (
            self.transform(that.asset_information)
        )
    ...
    def transform_asset_information(
        ...
        if that.default_thumbnail is not None:
            properties['default_thumbnail'] = (
                self.transform(that.default_thumbnail)
            )
    ...
    def transform_specific_asset_id(
        ...
        if that.external_subject_id is not None:
            properties['external_subject_ID'] = (
    ...
    def transform_relationship_element(
        ...
        properties['first'] = (
            self.transform(that.first)
        )

        properties['second'] = (
            self.transform(that.second)
        )
    ...
    def transform_event_payload(
        ...
        properties['source'] = (
            self.transform(that.source)
        )

        if that.source_semantic_id is not None:
            properties['source_semantic_ID'] = (
                self.transform(that.source_semantic_id)
            )

        properties['observable_reference'] = (
            self.transform(that.observable_reference)
        )

        if that.observable_semantic_id is not None:
            properties['observable_semantic_ID'] = (
        ...
        if that.subject_id is not None:
            properties['subject_ID'] = (
                self.transform(that.subject_id)
            )
    ...
    def transform_basic_event_element(
        ...
        if that.message_topic is not None:
            properties['message_topic'] = (
                that.message_topic
            )

        if that.message_broker is not None:
            properties['message_broker'] = (
                self.transform(that.message_broker)
            )
        ...
        if that.min_interval is not None:
            properties['min_interval'] = (
                that.min_interval
            )

        if that.max_interval is not None:
            properties['max_interval'] = (
                that.max_interval
            )
    ...
    def transform_reference(
        ...
        if that.referred_semantic_id is not None:
            properties['referred_semantic_ID'] = (
    ...
    def transform_environment(
        ...
        if that.asset_administration_shells is not None:
            properties['asset_administration_shells'] = (
                ListOfInstances(
                    [
                        self.transform(item)
        ...
        if that.concept_descriptions is not None:
            properties['concept_descriptions'] = (
                ListOfInstances(
                    [
                        self.transform(item)
    ...
    def transform_embedded_data_specification(
        ...
        properties['data_specification'] = (
            self.transform(that.data_specification)
        )

        properties['data_specification_content'] = (
    ...
    def transform_value_list(
        ...
        properties['value_reference_pairs'] = (
            ListOfInstances(
                [
                    self.transform(item)
    ...
    def transform_data_specification_iec_61360(
        ...
        if that.unit_id is not None:
            properties['unit_ID'] = (
                self.transform(that.unit_id)
            )

        if that.source_of_definition is not None:
            properties['source_of_definition'] = (
        ...
        if that.value_format is not None:
            properties['value_format'] = (
                that.value_format
            )

        if that.value_list is not None:
            properties['value_list'] = (
                self.transform(that.value_list)
            )
        ...
        if that.level_type is not None:
            properties['level_type'] = (
                self.transform(that.level_type)
            )
